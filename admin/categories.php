                                ...
                                <tr>
                                    ...
                                    <td class="p-2 border border-mabook-light/50">
                                        <div class="flex gap-2">
                                            ...
                                            <!-- Ganti form delete menjadi: -->
<form action="categories.php" method="POST" onsubmit="return confirm('Anda yakin?')">
    <input type="hidden" name="id" value="<?= $category['id'] ?>">
    <button type="submit" class="cursor-pointer"><i class="fas fa-trash text-red-400"></i></button>
</form>
                                        </div>
                                    </td>
                                </tr>
