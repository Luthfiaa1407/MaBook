                ...
                <div class="bg-mabook-primary w-full p-5 mt-3">
                    <form action="#" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" id="name" name="name" value="<?= $old['name'] ?? '' ?>" class="mabook-form-control" placeholder="Tuliskan kategori...">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" placeholder="Tuliskan deskripsi mengenai kategori ini..." class="mabook-form-control"><?= $old['description'] ?? '' ?></textarea>
