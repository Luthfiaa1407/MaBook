                            ...
                            <div class="mb-3">
                                ...
                                <select name="author_id" id="author_id" class="mabook-form-control">
                                    ...
                                    <?php foreach ($authors as $author): ?>
                                        <option <?= isset($old['author_id']) && $old['author_id'] == $author['id'] ? 'selected' : '' ?> value="<?= $author['id'] ?>"><?= $author['name'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="publisher_id" id="publisher_id" class="mabook-form-control">
                                    ...
                                    <?php foreach ($publishers as $publisher): ?>
                                        <option <?= isset($old['publisher_id']) && $old['publisher_id'] == $publisher['id'] ? 'selected' : '' ?> value="<?= $publisher['id'] ?>"><?= $publisher['name'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="year" id="year" class="mabook-form-control">
                                    ...
                                    <?php for ($i = date('Y'); $i >= 1990; $i--): ?>
                                        <option <?= isset($old['year']) && $old['year'] == $i ? 'selected' : '' ?> value="<?= $i ?>"><?= $i ?></option>
                                    <?php endfor; ?>
                                </select>
